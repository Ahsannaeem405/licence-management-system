                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-2 mb-md-0">
                        <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex py-75" id="account-pill-info" data-toggle="pill" href="#account-vertical-password" aria-expanded="false">
                                    <i class="feather icon-lock mr-50 font-medium-3"></i>
                                  Company Information
                                </a>
                            </li>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="tab-content">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        <h5>Company Name: 
                                                                            <span style="font-size: 14px">Brown tech int</span>
                                                                        </h5>
                                                                        {{-- <label >Company  name</label> --}}
                                                                        {{-- <input type="text" class="form-control" value="Sozu" required placeholder="" data-validation-required-message="This old password field is required"> --}}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        <h5>Department: 
                                                                            <span style="font-size: 14px">Computer Science</span>
                                                                        </h5>
                                                                        {{-- <label >Department  name</label> --}}
                                                                        {{-- <input type="text" class="form-control" value="information technology"required placeholder="" data-validation-required-message="This old password field is required"> --}}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        <h5>Email: 
                                                                            <span style="font-size: 14px">John1@gmail.com</span>
                                                                        </h5>
                                                                        {{-- <label >Department  name</label> --}}
                                                                        {{-- <input type="text" class="form-control" value="information technology"required placeholder="" data-validation-required-message="This old password field is required"> --}}
                                                                    </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        <h5>Address: 
                                                                            <span style="font-size: 14px">London</span>
                                                                        </h5>
                                                                        {{-- <label >Department  name</label> --}}
                                                                        {{-- <input type="text" class="form-control" value="information technology"required placeholder="" data-validation-required-message="This old password field is required"> --}}
                                                                    </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        <h5>Phone: 
                                                                            <span style="font-size: 14px"> 03106798412</span>
                                                                        </h5>
                                                                        {{-- <label >Department  name</label> --}}
                                                                        {{-- <input type="text" class="form-control" value="information technology"required placeholder="" data-validation-required-message="This old password field is required"> --}}
                                                                    </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <div class="controls">
                                                                        <h5>Subcription: 
                                                                            <span style="font-size: 14px">package1</span>
                                                                        </h5>
                                                                        {{-- <label >Department  name</label> --}}
                                                                        {{-- <input type="text" class="form-control" value="information technology"required placeholder="" data-validation-required-message="This old password field is required"> --}}
                                                                    </div>
                                        ...
                                        <div class="tab-pane fade " id="account-vertical-info" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                            <form novalidate>
                                                <div class="row">
                                                    {{-- <div class="col-12">
                                                        <div class="form-group">
