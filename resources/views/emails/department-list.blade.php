                            ...
                            <td>
                              <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #183153;padding-top: 0; padding-bottom: 0; padding-left: 20px; padding-right: 20px;">
                                <tbody>
                                  <tr>
                                    <td valign="top">
                                      <p style="font-family:arial;margin: 0; color: #fff;padding-top: 38px; font-size: 14px;font-weight: 600;">Customer Company</p>
                                      <p style="font-family:arial;margin: 0; color: #fff;font-size: 14px;font-weight: 600; padding-top: 5px;">Address</p>
                                    </td>
                              ...
                              <table cellspacing="0" cellspadding="0" width="100%">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">Export Department List</td>
                            ...
                            <table cellspacing="0" cellspadding="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="border:1px solid #fff;font-family:arial;font-size: 14px;font-weight: 600;text-align: left;background-color: #183153;color: #fff;padding-top: 5px;padding-bottom: 5px;padding-left: 5px;padding-right: 5px;">DESCRIPTION</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">{{$department->name}}</td>
                                        <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">{{$department->description}}</td>
                                        <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">{{\Carbon\carbon::createFromFormat('Y-m-d H:i:s',$department->created_at)->format('m/d/Y')}}</td>
