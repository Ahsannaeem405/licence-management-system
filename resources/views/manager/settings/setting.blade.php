                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                            ...
                                            <div class="media">
                                                ...
                                                <form novalidate
                                                    action="{{ route('manager-update-profile',$user->id) }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                    <button type="submit"
                                                        class="btn btn-primary mr-sm-1 mb-1 mb-sm-0">{{__('messages.save changes')}}
                                                        </button>
                                        ...
                                        <div class="tab-pane fade " id="account-vertical-password" role="tabpanel"
                                            ...
                                            <form  action="{{ route('manager-update-password', $user->id) }}" method="POST" novalidate>
                                                @csrf
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="account-retype-new-password">{{__('messages.conf new pass')}}
                                                                     </label>
