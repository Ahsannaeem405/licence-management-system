                              ...
                              <table cellspacing="0" cellspadding="0" width="100%">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">Export Manager List</td>
                            ...
                            <table cellspacing="0" cellspadding="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="border:1px solid #fff;font-family:arial;font-size: 14px;font-weight: 600;text-align: left;background-color: #183153;color: #fff;padding-top: 5px;padding-bottom: 5px;padding-left: 5px;padding-right: 5px;">NAME</th>
                                        <th style="border:1px solid #fff;font-family:arial;font-size: 14px;font-weight: 600;text-align: left;background-color: #183153;color: #fff;padding-top: 5px;padding-bottom: 5px;padding-left: 5px;padding-right: 5px;">Email</th>
                                        <th style="border:1px solid #fff;font-family:arial;font-size: 14px;font-weight: 600;text-align: left;background-color: #183153;color: #fff;padding-top: 5px;padding-bottom: 5px;padding-left: 5px;padding-right: 5px;">Role</th>
                                        ...
                                        <th style="border:1px solid #fff;font-family:arial;font-size: 14px;font-weight: 600;text-align: left;background-color: #183153;color: #fff;padding-top: 5px;padding-bottom: 5px;padding-left: 5px;padding-right: 5px;">CREATION DATE</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">{{$management->name}}</td>
                                        <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">{{$management->email}}</td>
                                        <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">{{$management->role}}</td>
                                        <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">{{$management->department->name}}</td>
                                        <td style="border:1px solid #fff;background-color: #d9d9d9;padding-top: 12px;padding-bottom: 12px;padding-left: 12px;padding-right: 12px;">{{\Carbon\carbon::createFromFormat('Y-m-d H:i:s',$management->created_at)->format('m/d/Y')}}</td>
