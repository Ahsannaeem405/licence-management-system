                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST" action="{{route('customer-store-license')}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="reffer" required>
                                                            ...
                                                            <option value="{{$user->id}}" @if(old('reffer') == $user->id ) selected @endif>{{$user->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="date" name="renew_date" value="{{old('renew_date')}}" min="{{ date('Y-m-d') }}" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Expiry of Date</label>
                                                        <div class="controls">
                                                            <input type="date" name="expiry" value="{{old('expiry')}}" min="{{ date('Y-m-d') }}" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
